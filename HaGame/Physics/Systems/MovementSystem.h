	...
	namespace physics {
		class MovementSystem : public hagame::ecs::System {
			...
			void handleSimpleMovement(double dt) {
				forEach<SimpleMovement>([this, dt](SimpleMovement* sm, RawPtr<ecs::Entity> entity) {
			...
			void handleRotationMovement(double dt) {
				forEach<RotationMovement>([this, dt](RotationMovement* rm, RawPtr<ecs::Entity> entity) {
